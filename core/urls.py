...
urlpatterns = [
    ...
    # Жалобы
    path('reports/create/<str:target_type>/<int:target_id>/', views.create_report, name='create_report'),
    ...
    path('admin/warnings/<int:warning_id>/respond/', views.respond_to_warning, name='respond_to_warning'),
